<!--// ADDRESS //-->
<div class="living_situation">
	<div class="finance_applicant_cell">
		<?php _e('Apt/Suite', 'car-demon'); ?>
	</div>
	<div class="finance_applicant_cell">
		<input name="app_apt_num" type="text" id="app_apt_num" tabindex="6" size="6" maxlength="5" />
		<div id="msgDivapp_apt_num" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<input name="app_street_num" type="text" id="app_street_num" onKeyPress="checkNum()" tabindex="7" onChange="ValidateAppAddress();" size="6" maxlength="6" />
		<div id="msgDivapp_street_num" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<input name="app_street_name" type="text" maxlength="20" id="app_street_name" tabindex="8" />
		<div id="msgDivapp_street_name" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<select name="app_street_type" id="app_street_type" class="select" tabindex="9">
		...
		<div id="msgDivapp_street_type" class="finance_hide_notice"><font color="#FF0000" size="-1">
			<?php _e('STREET TYPE REQUIRED', 'car-demon'); ?></font>
		</div>
	</div>
	<div class="finance_applicant_cell">
	...
	<div class="finance_applicant_cell">
		<input name="app_po_box_num" type="text" id="app_po_box_num" onKeyPress="checkNum()" tabindex="10" size="6" maxlength="6" onChange="ValidateAppAddress();" />
		<div id="msgDivapp_po_box_num" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<input name="app_rural_route" type="text" id="app_rural_route" tabindex="11" size="6" maxlength="6" onChange="ValidateAppAddress();" />
		<div id="msgDivapp_rural_route" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<input type="text" name="cty" id="cty" value="" maxlength="200" tabindex="12" />
		<div id="msgDivcty" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		...
		<div id="msgDivst" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<input type="text" name="zi" id="zi" value="" onKeyPress="checkNum()" maxlength="200" tabindex="14" />
		<div id="msgDivzi" class="finance_hide_notice">
	...
	<div class="finance_applicant_cell">
		<select name="bdm" id="bdm" tabindex="15">
			<option selected="selected"></option>
	...
	<div id="msgDivbdd" class="finance_hide_notice">
		<font color="#FF0000" size="-1"><?php _e('DAY REQUIRED', 'car-demon'); ?></font>
	</div>
	<div id="msgDivbdm" class="finance_hide_notice">
		<font color="#FF0000" size="-1"><?php _e('MONTH REQUIRED', 'car-demon'); ?></font>
	</div>
	<div id="msgDivbdy" class="finance_hide_notice">
