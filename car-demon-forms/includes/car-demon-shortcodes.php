<?php
function cd_test_tag_func( $atts ) {
	extract( shortcode_atts( array(
		'foo' => 'no foo',
		'bar' => 'default bar',
	), $atts ) );
	$my_btn = '<input type="button" id="my_test_btn" value="test ajax" />';
	...
	$link = admin_url('admin-ajax.php?action=my_user_vote&post_id='.$post_id.'&nonce='.$nonce);
	echo '<span class="user_vote" data-nonce="' . $nonce . '" data-post_id="' . $post_id . '">vote for this article</span>';
	
	return $my_btn;
}
add_shortcode( 'test_tag', 'cd_test_tag_func' );
//==========================================================================
