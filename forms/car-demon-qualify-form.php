...
function car_demon_qualify_form($location, $popup_id, $popup_button) {
	...
	global $cd_formKey;
	wp_enqueue_script('car-demon-qualify-us-form-js', WP_CONTENT_URL . '/plugins/car-demon/forms/js/car-demon-qualify.js.php');
	...
	if (!empty($popup_id)) {
		...
		wp_enqueue_script('car-demon-qualify-popup-js', WP_CONTENT_URL . '/plugins/car-demon/forms/js/car-demon-qualify-popup.js.php');
		wp_enqueue_style('car-demon-qualify-popup-css', WP_CONTENT_URL . '/plugins/car-demon/forms/css/car-demon-qualify-popup.css');
