...
function car_demon_service_quote($location, $popup_id = '', $popup_button='') {
	...
	if (!empty($popup_id)) {
		...
		wp_enqueue_script('car-demon-service-quote-popup-js', WP_CONTENT_URL . '/plugins/car-demon/forms/js/car-demon-service-quote-popup.js.php');
		wp_enqueue_style('car-demon-service-quote-popup-css', WP_CONTENT_URL . '/plugins/car-demon/forms/css/car-demon-service-quote-popup.css');
