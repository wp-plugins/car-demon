...
function CalendarControl() {
  ...
  function calendarDrawTable() {
	...
	table = table + "   Pick Time";
	table = table + "  </td>";
	table = table + "  <td colspan='5' class='title'>";
	table = table + "   <select id='service_time'><option value='Early Morning'>Early Morning</option><option value='Mid Morning'>Mid Morning</option><option value='Late Morning'>Late Morning</option><option value='Early Afternoon'>Early Afternoon</option><option value='Mid Afternoon'>Mid Afternoon</option><option value='Late Afternoon'>Late Afternoon</option></select>";
	table = table + "  </td>";
	table = table + "</tr>";
