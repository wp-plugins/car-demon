...
if ($is_it_iis == 'Apache') {
	$newPath = str_replace('wp-content/plugins/car-demon/content-replacement/theme-files/content-replacement', '', $newPath);
	include_once($newPath."/wp-load.php");
	include_once($newPath."/wp-includes/wp-db.php");
} else {
	$newPath = str_replace('wp-content\plugins\car-demon\content-replacement\theme-files\content-replacement', '', $newPath);
	include_once($newPath."\wp-load.php");
	include_once($newPath."\wp-includes/wp-db.php");
}
...
function open_car_demon_lightbox(my_img) {
	...
	var box = document.getElementById('photo_thumbs').innerHTML;
